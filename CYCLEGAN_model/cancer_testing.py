...
dataloader, bulk, sig, fra_gt, fra_ini = cancer_dataset_process(data_path_list, log_icon=True, add_noise=False, fra_ini_icon = 'rand')
...
optimizer_D_sc = optim.RMSprop(D_sc.parameters(), lr=learning_rate)
